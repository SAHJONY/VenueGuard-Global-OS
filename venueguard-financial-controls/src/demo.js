...
console.log(JSON.stringify({
  ...
  kyc: screenKyc({ type: "BUSINESS", legalName: "VELVET TH", registrationNumber: "demo", registeredAddress: "demo", taxId: "demo", beneficialOwners: ["owner_1"], bankOwnershipEvidence: "demo" }),
